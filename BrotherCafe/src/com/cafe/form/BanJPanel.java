...
public class BanJPanel extends javax.swing.JPanel {
 ...
 List<String> khuVuc = new ArrayList<>();
    ...
    public BanJPanel() {
        ...
        for(String kv : khuVuc){
            cboChonKhuVuc.addItem(kv);
        }
    }
...
//                    MsgBox.alert(this, "Thêm mới thất bại", JOptionPane.WARNING_MESSAGE);
    ...
    void fillTable() {
        ...
        try {
            ...
            List<Ban> list = banDao.selectByKeyWord(keyWord);
            for (Ban ban : list) {
                Object[] row = {ban.getMaBan(), ban.getTenBan(), ban.getKhuVuc(), ban.getTrangThai()};
                model.addRow(row);
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
    ...
    private void focusInput() {
        ...
        cboChonKhuVuc.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                cboChonKhuVuc.setBackground(new Color(227, 188, 140));
                cboChonKhuVuc.setBorder(borderNhanVao);
            }

            @Override
            public void focusLost(FocusEvent e) {
                cboChonKhuVuc.setBackground(new Color(255, 255, 255));
                cboChonKhuVuc.setBorder(borderKhongNhan);
            }
        });
    ...
    private void setBorderInput() {
        ...
        cboChonKhuVuc.setBorder(border);
