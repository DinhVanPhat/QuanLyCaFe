 ...
 * @author ADMIN
 */
public class GiaoDienChaoJDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaoDienChaoJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaoDienChaoJDialog dialog = new GiaoDienChaoJDialog(new javax.swing.JFrame(), true);
